...
<div class="row justify-content-center">
    <div class="col-md-8">
        ...
        <div class="bg-white rounded-3 p-4" style="border:1px solid #e5e7eb;">
            <h5 class="fw-700 mb-4" style="font-size:18px; font-weight:700;">Create New Task</h5>
            ...
            <form action="{{ route('tasks.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" rows="4"
                        class="form-control" placeholder="Enter task description...">{{ old('description') }}</textarea>
                </div>
